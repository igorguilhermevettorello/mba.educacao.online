...
{
    public static class PagamentoMigrationExec
    {
        public static async Task Exec(IServiceProvider serviceProvider)
        {
            ...
            EnsureDatabaseFileExists(pagamentoContext);

            await pagamentoContext.Database.MigrateAsync();
        }

        private static void EnsureDatabaseFileExists(PagamentoContext context)
        {
