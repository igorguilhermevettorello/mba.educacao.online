...
public class UnitTestCurso
{
    ...
    public void CriarCurso_DadosValidos_DeveCriarComSucesso()
    {
        ...
        // Act
        var curso = new Domain.Entities.Curso(titulo, descricao, nivel);
    ...
    {
        // Act & Assert
        Assert.Throws<ArgumentException>(() => new Domain.Entities.Curso(titulo, descricao, status));
    }
    ...
    {
        // Arrange
        var curso = new Domain.Entities.Curso("MBA em Gestão", "Descrição do curso", NivelCurso.Basico);
    ...
    {
        // Arrange
        var curso = new Domain.Entities.Curso("MBA em Gestão", "Descrição do curso", NivelCurso.Intermediario);
    ...
    public void CriarCurso_NivelBasico_DeveCriarComNivelBasico()
    {
        ...
        // Act
        var curso = new Domain.Entities.Curso(titulo, descricao, status);
    ...
    {
        // Arrange
        var curso = new Domain.Entities.Curso("Curso de Teste", "Descrição", NivelCurso.Basico);
    ...
    {
        // Arrange
        var curso = new Domain.Entities.Curso("Curso de Teste", "Descrição", statusInicial);
    ...
    public void CriarCurso_NivelInvalido_DeveLancarExcecao()
    {
        ...
        // Act & Assert
        Assert.Throws<ArgumentException>(() => new Domain.Entities.Curso(titulo, descricao, statusInvalido));
    }
    ...
    {
        // Arrange
        var curso = new Domain.Entities.Curso("MBA em Gestão de Projetos", "Curso completo de MBA", NivelCurso.Avancado);
